...
10. **Accounts is migrated to feature-owned React Query hooks.** Dashboard, budget, periods, reconciliation, and the remaining auxiliary screens still have legacy request orchestration and are next migration candidates.
